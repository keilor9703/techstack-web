...
const techStack = [
  {
    label: 'React 18', desc: 'Frontend SPA', color: '#61DAFB', bg: '#20232A',
  ...
  {
    label: 'FastAPI', desc: 'Backend Python 3.11', color: '#009688', bg: '#1a1a1a',
  ...
  {
    label: 'PostgreSQL 17', desc: 'Base de datos', color: '#336791', bg: '#fff',
    svg: <svg viewBox="0 0 24 24" fill="#336791" className="w-5 h-5"><path d="M17.128 0a10.134 10.134 0 0 0-2.755.403l-.063.02A10.922 10.922 0 0 0 12.6.258C11.422.238 10.41.524 9.594 1 8.79.721 7.122.24 5.364.336 4.14.403 2.804.775 1.814 1.82.827 2.865.305 4.482.415 6.682c.03.607.131 1.202.24 1.772.109.57.227 1.112.3 1.585.138.866.17 1.557.069 1.955-.1.397-.513.974-.816 1.529-.304.555-.576 1.126-.682 1.653-.105.527-.027 1.078.499 1.478.526.4 1.507.507 3.05-.044.516-.185 1.08-.406 1.615-.661.535-.255 1.037-.526 1.382-.754.402.286.837.543 1.284.764.623.308 1.325.571 2.095.694l.072.012c.034.006.068.01.102.015-.06.72-.094 1.586.014 2.377.146 1.08.516 2.143 1.08 2.86.287.358.638.622 1.057.758.418.135.86.196 1.324.196.84 0 1.752-.178 2.79-.404.94-.207 2.019-.414 3.158-.435.58-.01 1.187.022 1.805.104l.053.007c.376.046.738-.05 1.008-.23.27-.182.46-.453.502-.782.095-.73-.484-1.415-1.46-1.862-.494-.23-1.077-.394-1.636-.53l-.033-.008c.291-1.129.484-2.418.558-3.709.08-1.418.021-2.836-.277-4.025-.16-.637-.42-1.27-.77-1.802-.347-.53-.817-.987-1.43-1.26L17.128 0zm-.36 1.201c.51.132.98.337 1.358.603.823.577 1.24 1.44 1.483 2.399.244.96.301 2.05.257 3.17-.043 1.117-.188 2.273-.415 3.364-.028.133-.058.266-.089.398-.213-.073-.44-.14-.681-.199-.634-.158-1.334-.26-2.024-.315-.69-.055-1.379-.063-2.017-.016-.31.023-.612.065-.902.13l-.108.026a5.583 5.583 0 0 0-.386.11c.026-.344.052-.69.075-1.036.084-1.25.14-2.509.135-3.664-.004-1.155-.075-2.208-.243-2.998-.13-.606-.345-1.133-.66-1.515.043-.003.087-.008.13-.01.905-.054 1.697.07 2.356.262l.108.033c.109.035.212.073.31.113.034.014.068.028.1.043l-.03-.009c.172.074.318.152.44.228.089.056.165.11.234.162zm-5.405.37c.069 0 .14.002.21.006.42.022.836.132 1.207.308.23.11.436.257.61.43-.082.35-.152.84-.174 1.48-.05 1.398.029 3.222.195 4.98.059.62.128 1.228.198 1.802-.273.093-.546.205-.822.337-.587.28-1.176.637-1.67 1.029l-.108.088c-.03-.05-.063-.1-.097-.148-.293-.42-.705-.762-1.13-1.048-.318-.214-.67-.397-1.028-.548.064-.51.108-1.06.128-1.65.063-1.89-.076-4.057-.47-5.744-.07-.3-.153-.585-.246-.852a4.78 4.78 0 0 1 1.21-.227c.065-.003.129-.004.193-.004l-.206.005zm-4.784.996c.616 0 1.214.098 1.69.257.209.67.4 1.516.487 2.52.075.862.078 1.828.024 2.832-.053 1.003-.165 2.042-.33 3.03-.05.3-.105.592-.163.873-.53-.09-1.009-.115-1.407-.07-.546.064-.97.25-1.25.536-.28.285-.424.666-.392 1.13.068 1.001.752 2.12 1.583 3.054a7.74 7.74 0 0 0 .324.34c-.26.044-.524.052-.788.022a3.405 3.405 0 0 1-.752-.184c-.47-.171-.85-.435-1.09-.757-.48-.642-.73-1.526-.83-2.42-.099-.893-.071-1.813-.018-2.596.085-1.232.28-2.157.364-2.466.152-.556.11-1.364-.044-2.31-.083-.512-.2-1.066-.313-1.629-.112-.563-.214-1.135-.24-1.686-.08-1.56.284-2.623.886-3.259.601-.635 1.437-.913 2.4-.966a6.58 6.58 0 0 1 .663-.001zm13.376 1.002.083.01c.43.054.786.269 1.057.603.54.666.822 1.719.912 2.897.091 1.178.004 2.542-.192 3.87-.195 1.327-.499 2.62-.848 3.668-.1.298-.201.567-.296.808a7.526 7.526 0 0 0-1.648-.005c.075-.29.151-.6.225-.928.27-1.196.47-2.615.546-3.987.077-1.372.04-2.706-.156-3.73a4.841 4.841 0 0 0-.193-.706l.004.013c-.116-.37-.283-.71-.505-1.006a3.73 3.73 0 0 0-.228-.274c.417.203.845.408 1.239.767zm-12.18 9.649c.21.005.412.02.603.046.382.051.72.144.993.271.275.129.49.294.63.484.14.19.2.402.17.64-.06.465-.455.98-1.035 1.44-.29.23-.614.442-.943.626-.263-.261-.527-.564-.77-.893-.467-.635-.853-1.34-.955-1.892a1.333 1.333 0 0 1-.018-.34c.013-.14.057-.263.144-.366.088-.102.22-.19.407-.248.187-.058.425-.085.706-.083.024 0 .046-.002.07-.001l-.001.316zM12.74 18.8c.274.02.54.054.8.103-.243.428-.52.842-.823 1.205-.304.363-.627.665-.944.847a2.634 2.634 0 0 1-.47.219c-.179.06-.367.096-.563.107a2.63 2.63 0 0 1-.483-.022c.065-.225.168-.55.3-.929.133-.378.302-.807.501-1.208.218.047.434.09.65.126a9.5 9.5 0 0 0 1.032.113v-.561zm4.058-.088c.36.118.696.254.988.407.293.154.544.32.728.493l.082.083c.252.276.35.548.296.792-.046.203-.198.395-.467.544-.27.148-.66.25-1.14.28-.237.014-.496.007-.77-.024l-.054-.007c.012-.083.024-.167.034-.252.052-.429.086-.869.105-1.313.015-.334.02-.672.014-1.003h.184zm-2.888.25c.087.002.173.005.258.01.27.017.532.05.783.097-.012.296-.035.593-.069.887-.039.327-.09.648-.154.953-.196-.02-.385-.05-.565-.086a5.842 5.842 0 0 1-.73-.218c.106-.447.247-.905.418-1.353.02-.05.04-.098.059-.148v-.142zm-1.43.282c-.127.363-.237.735-.32 1.09-.068.296-.117.58-.143.847a3.27 3.27 0 0 1-.506-.232c-.216-.14-.386-.303-.49-.476a.94.94 0 0 1-.13-.37c.018-.17.112-.353.298-.518.186-.165.463-.31.808-.41.15-.044.31-.08.483-.11v-.021z"/></svg>,
  },
  {
    label: 'Oracle Cloud', desc: 'Infraestructura ARM', color: '#F80000', bg: '#fff',
  ...
  {
    label: 'Pydantic v2', desc: 'Validación', color: '#e92063', bg: '#fff',
  ...
  {
    label: 'SQLAlchemy', desc: 'ORM', color: '#D71F00', bg: '#fff',
  ...
  {
    label: 'Vercel CDN', desc: 'Frontend global', color: '#000000', bg: '#fff',
    svg: <svg viewBox="0 0 24 24" fill="#000" className="w-5 h-5"><path d="M24 22.525H0l12-21.05 12 21.05z"/></svg>,
  },
  {
    label: 'Nginx + SSL', desc: 'Proxy inverso', color: '#009900', bg: '#fff',
  ...
  {
    label: 'Wompi', desc: 'Pagos Colombia', color: '#6B2DE3', bg: '#fff',
  ...
  {
    label: 'DIAN / Matias', desc: 'Facturación electrónica', color: '#003DA6', bg: '#fff',
  ...
  {
    label: 'WebAuthn FIDO2', desc: 'Biométrico', color: '#0066CC', bg: '#fff',
  ...
  {
    label: 'WhatsApp API', desc: 'Notificaciones', color: '#25D366', bg: '#fff',
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-12">
            <Section>
              ...
              <motion.div variants={stagger} className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {techStack.map((t, i) => (
                  <motion.div key={i} variants={fadeUp} className="bg-white border border-gray-100 rounded-xl px-4 py-3 hover:border-azulStack/30 hover:shadow-sm transition-all flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg flex-shrink-0 flex items-center justify-center" style={{ backgroundColor: t.color + '18', border: `1px solid ${t.color}30` }}>
                      {t.svg}
                    </div>
                    <div>
